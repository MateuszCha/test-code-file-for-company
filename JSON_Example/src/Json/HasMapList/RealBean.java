...
/*
List    	@JsonDeserialize(as = list.class. contentAs = ValueTypeImpl.class)
Map	        @JsonDeserialize(as = Map.class, keyAs = KeyTypeImpl.class)
 */
public class RealBean {
    protected final int id;
    protected final String name;
    @JsonDeserialize(as = HashMap.class, keyAs = String.class)
